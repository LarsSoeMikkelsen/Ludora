...
cp -a theme-source/look-and-feel/* %{buildroot}%{_datadir}/plasma/look-and-feel/org.ludora.desktop/

# Install wallpaper
mkdir -p %{buildroot}%{_datadir}/wallpapers/Ludora
cp -a theme-source/wallpaper/* %{buildroot}%{_datadir}/wallpapers/Ludora/
...
cp theme-source/icons/scalable/ludora-start-here.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/apps/
cp theme-source/icons/64x64/ludora-start-here.png %{buildroot}%{_datadir}/icons/hicolor/64x64/apps/
cp theme-source/icons/128x128/ludora-start-here.svg %{buildroot}%{_datadir}/icons/hicolor/128x128/apps/
cp theme-source/icons/256x256/ludora-start-here.svg %{buildroot}%{_datadir}/icons/hicolor/256x256/apps/
